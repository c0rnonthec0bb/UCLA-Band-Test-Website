...
//on change
	...
	<p class="text-center">
		<br>
		<a href="http://awplife.com/account/signup/media-slider-premium" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize">Buy Premium Version</a>
